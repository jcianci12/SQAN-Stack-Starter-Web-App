...
export class NotificationEndpoint {
    ...
    getNotificationEndpoint<T>(notificationId: number|undefined): Observable<T|null> {
    ...
    getNotificationsEndpoint<T>(page: number, pageSize: number): Observable<T|null> {
    ...
    getUnreadNotificationsEndpoint<T>(userId?: string): Observable<T|null> {
    ...
    getNewNotificationsEndpoint<T>(lastNotificationDate?: Date): Observable<T|null> {
    ...
    getPinUnpinNotificationEndpoint<T>(notificationId: number, isPinned?: boolean, ): Observable<T|null> {
    ...
    getReadUnreadNotificationEndpoint<T>(notificationIds: number[], isRead: boolean, ): Observable<T|null> {
    ...
    getDeleteNotificationEndpoint<T>(notificationId: number): Observable<T|null> {
