...
export class AccountEndpoint extends EndpointBase {
  ...
  constructor(private configurations: ConfigurationService, http: HttpClient, authService: AuthService,authguard:AuthGuard,
    router: Router,
    activatedRoute: ActivatedRoute
    ) {
    super(http, authService,authguard,router,activatedRoute);
  }
