...
export class Utilities {
  ...
  public static safeStringify(object:any) {
    ...
    for (const prop in object) {
      ...
      simpleObject[parseInt( prop)] = object[prop];
    }
  ...
  public static toLowerCase(items: string[]):any;
  public static toLowerCase(items: any): string | string[]|undefined {
  ...
  public static removeNulls(obj: any[]) {
    ...
    for (const k in obj) {
      if (obj[k] === null) {
        isArray ? obj.splice(  parseInt( k), 1) : delete obj[k];
