...
export class RolesManagementComponent implements OnInit, AfterViewInit {
  ...
  editingRoleName!: { name: string }|null;
  ...
  ngOnInit() {
    ...
    this.columns = [
      ...
      new column( "Name",40,null,true,false,true,true,"name"),
      new column( "Description",40,null,true,false,true,true,"description"),
      new column( "Users",40,null,true,false,true,true,"usersCount"),
      new column( "",40,this.actionsTemplate,true,false,true,true,"")
    ];
